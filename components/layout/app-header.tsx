...
import { ChevronDown, ClipboardList, LogOut, Pill, Settings, Store, User } from "lucide-react";
          ...
          {user?.role === "admin" && (
            <>
              ...
              >
                ...
                <span className="hidden sm:inline">{t.nav.adminPharmacies}</span>
              </Link>
              <Link
              ...
              >
                ...
                <span className="hidden sm:inline">{t.nav.adminMedicines}</span>
              </Link>
            </>
          )}
