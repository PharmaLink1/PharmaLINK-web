/**
 * Ambient page background: a faint technical grid plus a soft green accent glow,
...
export function Backdrop() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute left-1/2 top-[-20%] h-[520px] w-[900px] -translate-x-1/2 rounded-full bg-primary/15 blur-[130px]" />
    </div>
  );
}
